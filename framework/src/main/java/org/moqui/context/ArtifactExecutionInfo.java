...
public interface ArtifactExecutionInfo {
    enum ArtifactType { AT_XML_SCREEN, AT_XML_SCREEN_TRANS, AT_XML_SCREEN_CONTENT, AT_SERVICE, AT_ENTITY, AT_REST_PATH, AT_LLM, AT_OTHER }
    ...
    ArtifactType AT_LLM = ArtifactType.AT_LLM;
